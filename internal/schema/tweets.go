...
var TweetWhere = struct {
	...
	UserID:    whereHelperint{field: "`tweets`.`user_id`"},
	Content:   whereHelperstring{field: "`tweets`.`content`"},
	ImageURL:  whereHelpernull_String{field: "`tweets`.`image_url`"},
...
var (
	tweetAllColumns            = []string{"id", "user_id", "content", "image_url", "created_at", "updated_at"}
	tweetColumnsWithoutDefault = []string{"user_id", "content", "image_url"}
	tweetColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
func (q tweetQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Tweet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: failed to execute a one query for tweets")
	}
...
func (q tweetQuery) All(ctx context.Context, exec boil.ContextExecutor) (TweetSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "schema: failed to assign all query results to Tweet slice")
	}
...
func (q tweetQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to count tweets rows")
	}
...
func (q tweetQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schema: failed to check if tweets exists")
	}
...
func (o *Tweet) AddLikes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Like) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ID, rel.UserID, rel.TweetID}
...
func FindTweet(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Tweet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: unable to select from tweets")
	}
...
func (o *Tweet) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no tweets provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to insert into tweets")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to populate default values for tweets")
	}
...
func (o *Tweet) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schema: unable to update tweets, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update tweets row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by update for tweets")
	}
...
func (q tweetQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all for tweets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected for tweets")
	}
...
func (o TweetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all in tweet slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected all in update all tweet")
	}
	return rowsAff, nil
}
...
func (o *Tweet) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no tweets provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("schema: unable to upsert tweets, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to upsert for tweets")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to retrieve unique values for tweets")
	}
...
func (o *Tweet) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("schema: no Tweet provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete from tweets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by delete for tweets")
	}
...
func (q tweetQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("schema: no tweetQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from tweets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by deleteall for tweets")
	}
...
func (o TweetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from tweet slice")
	}
...
func (o *TweetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to reload all in TweetSlice")
	}
...
func TweetExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schema: unable to check if tweets exists")
	}
