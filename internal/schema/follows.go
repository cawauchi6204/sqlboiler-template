...
func (q followQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Follow, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: failed to execute a one query for follows")
	}
...
func (q followQuery) All(ctx context.Context, exec boil.ContextExecutor) (FollowSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "schema: failed to assign all query results to Follow slice")
	}
...
func (q followQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to count follows rows")
	}
...
func (q followQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schema: failed to check if follows exists")
	}
...
func FindFollow(ctx context.Context, exec boil.ContextExecutor, followerID int, followingID int, selectCols ...string) (*Follow, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: unable to select from follows")
	}
...
func (o *Follow) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no follows provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to insert into follows")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to populate default values for follows")
	}
...
func (o *Follow) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schema: unable to update follows, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update follows row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by update for follows")
	}
...
func (q followQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all for follows")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected for follows")
	}
...
func (o FollowSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all in follow slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected all in update all follow")
	}
	return rowsAff, nil
}
...
func (o *Follow) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no follows provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("schema: unable to upsert follows, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to upsert for follows")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to retrieve unique values for follows")
	}
...
func (o *Follow) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("schema: no Follow provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete from follows")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by delete for follows")
	}
...
func (q followQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("schema: no followQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from follows")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by deleteall for follows")
	}
...
func (o FollowSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from follow slice")
	}
...
func (o *FollowSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to reload all in FollowSlice")
	}
...
func FollowExists(ctx context.Context, exec boil.ContextExecutor, followerID int, followingID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schema: unable to check if follows exists")
	}
